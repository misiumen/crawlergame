...
signal body_part_wounded(target_id: int, zone: String, wound: String, severity: String)
signal body_part_severed(target_id: int, zone: String)
signal entity_maimed(target_id: int, status: String, zone_label: String)
