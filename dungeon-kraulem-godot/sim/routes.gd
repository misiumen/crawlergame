...
## key -> {label, blurb, enemy_mul, object_mul, trap_mul, object_tags, mob_tags}.
...
const BIOMES: Dictionary = {
	"sortownia": {
		...
		"mob_tags": ["robot", "machine", "robactwo"],
	},
	"konflikt": {
	...
	"pulapki": {
		...
		"mob_tags": ["machine", "camera", "drone", "robot"],
	},
	"zamknieta": {
	...
	"serwis": {
		...
		"mob_tags": ["robactwo", "insect", "drone"],
	},
	"skrot": {
	...
	"muzeum_spektakli": {
		...
		"mob_tags": ["undead", "ghost", "construct"],
	},
	"bar_skurczybyk": {
