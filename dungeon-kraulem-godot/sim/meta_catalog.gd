...
const CATALOG: Dictionary = {
	...
	"biome_lawowe_tunele":      {"kind": "biome", "label": "Lawowe Tunele", "reward": "Magma i jaszczury: ekstremalne, ale spektakularne.", "cost": 26, "effect": {"biome": {"hazard_kind": "fire", "label": "Lawowe Tunele", "blurb": "Magma i gady. Brutalne — i spektakularne.", "enemy_mul": 1.5, "object_mul": 0.9, "trap_mul": 1.6, "object_tags": ["hazard", "metal"]}}},
}
